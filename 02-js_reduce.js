...
const sum = numbers.reduce(callBack,0 )// Starting value of the accumulator is teh second parameter
...
const students = [
    ...
    {firstName: 'Jessy', lastName: "Mr Scrude,",age:99},
    {firstName: 'Lisa', lastName: "Parker",age:22},
    {firstName: 'Marco', lastName: "Mr Scrude,",age:48}
]



const count = students.reduce( (count, student) => {
